...
/**
 * Removes the node pointed to by the given node pointer and returns
 * the pointer to it . If the list is NULL or empty, or the
 ...
 */
NodePtr search(ListPtr list, const void *);
